package pt.link.citizencard.ptcitizencard.saml;
...
import pt.link.citizencard.ptcitizencard.xml.PrettyPrinter;
...
public class SAML
{
    ...
    */
        ...
        throws Exception
    {
        ...
        if(CitizenCard.loadPteidLib()){
        	if(cc.getData() && cc.getAddress()){
        		System.out.println("Card was read with success");
